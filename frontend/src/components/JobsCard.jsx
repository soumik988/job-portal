...
const JobsCard = ({job}) => {
  ...
  return (
    <div onClick={()=>navigate(`/job-details/${job._id}`)} className='p-5 
    flex flex-col rounded-md border border-gray-300 w-auto lg:w-[424px]
   bg-gradient-to-r from-purple-200/80 cursor-pointer gap-1 '>
